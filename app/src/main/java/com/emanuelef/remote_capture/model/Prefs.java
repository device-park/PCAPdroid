...
public class Prefs {
    ...
    // Sabit API Key - tüm cihazlarda aynı değer kullanılacak
    public static final String DEFAULT_API_KEY = "PCAPdroid-2024-Static-Key-12345";
    ...
    // API key'i sabit değer olarak döndür
    public static String getApiKey(SharedPreferences p)         { return DEFAULT_API_KEY; }
